...
def open_file():
    ...
    # of a file is opened than display the content of the file
    with open(filepath, "r") as inpput_file:
...
btn_save = Button(fr_button, texxt="Save As...", command=save_file)
